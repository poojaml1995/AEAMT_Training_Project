...
include '../includes/connection.php';
  ...
  if (isset($_GET['Course_Code'])) {
    ...
    $query = mysqli_query($con, "SELECT * FROM programme_schedule WHERE Course_Code='$Course_Code'") or die(mysqli_error($con));
        ...
        <div class="container">
            <div class="row mt-5">
                <div class="bordered-form mt-5 p-3 mx-2">
                          <?php
                            if (isset($_GET['Course_Code']) && !empty($results)) {
                              $i = 1;
                          ?>
                            <div class="row">
                                <div class="col-md-2">
                                ...
                                <p class="text-center">Tumkur Road, Bangalore - 560022 <br> Training Program <br>
                                  On <br> <strong>'<?php echo $results[0]['Title']; ?>'</strong> <br> <?php echo ($results[0]
                                  ['Commencing_Date']); ?></p>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="p-5">
                                                  ...
                                                  <div class="col-md-12">
                                                    <div class="d-flex justify-content-between align-items-center mt-2">
                                                        ...
                                                        <div class="text-center w-100">
                                                            <h4 class="fw-bold mb-0">Programme schedule</h4>
                                                        </div>
