...
<head>
    ...
    <title>View Course Details - AEAMT</title>
                ...
                <div class="col">
                    <div class="table-responsive">
                        <div class="table-bg shadow top-border mt-5 p-3 mx-2">
                            <div class="p-5">
                                <h4 class="heading text-left fw-bold mb-3">Course Details</h4>
                                ...
                                <table id="example" class="table table-bordered">
                                    ...
                                    if (mysqli_num_rows($query) > 0) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $id=$row['Course_Code']; ?></td>
                                            <td><?php echo $row['Title']; ?></td>
                                            <td><?php echo $row['No_of_Days']; ?></td>
                                            <td><?php echo $row['Commencing_from_Date'] . ', ' . $row['Commencing_to_Date']; ?></td>
                                            <td><?php echo $row['Course_Fee']; ?></td>
                                            <td><?php echo $row['Faculty']; ?></td>

                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="edit-coursedetails.php?Course_Code=<?php echo $id; ?>"
                                                        class='btn btn-primary btn-sm me-1 rounded-end'>Edit</a>
                                                    <a href='delete-coursedetails.php?Course_Code=<?php echo $id; ?>'
