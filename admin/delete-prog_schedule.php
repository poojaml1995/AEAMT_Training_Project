<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Delete Programme schedule - AEAMT</title>
...
if (isset($_GET['ID'])) {
    ...
    $delete_query = "DELETE FROM programme_schedule WHERE ID = '$id'";
    ...
    if ($delete_result) {
            ...
            ?>
                <script>
                    document.getElementById("AlertHeader").innerHTML = "Selected Programme schedule Deleted Successfully";
