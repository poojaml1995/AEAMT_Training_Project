    ...
    <head>
        ...
        <title>Delete Course Details - AEAMT</title>
...
if (isset($_GET['Course_Code'])) {
    ...
    $delete_query = "DELETE FROM course_details WHERE Course_Code = '$id'";
    ...
    if ($delete_result) {
            ...
            ?>
                <script>
                    document.getElementById("AlertHeader").innerHTML = "Selected Course Details Deleted Successfully";
