...
//     $query = mysqli_query($con, "SELECT * FROM enrollment_form WHERE Course_Code='$Course_Code'") or die(mysqli_error($con));
                ...
                <div class="training-form-border bg-light rounded-lg">
                    ...
                    <form onsubmit="return validateform()" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="Contact_No" class="font-weight-bold">Contact Number:</label>
                                    <span style="color:red">*</span>
